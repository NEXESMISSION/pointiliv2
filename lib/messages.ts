...
const MESSAGES: Record<string, string> = {
  ...
  business_unavailable: "This business isn't available on Pointidi right now.",
  own_business: "You can't collect stamps at your own business.",
  card_inactive: "This business hasn't set up its loyalty card yet.",
  not_authenticated: "Create your Pointidi account to collect your stamp.",
  // merchant
  subscription_expired: "Your Pointidi subscription has expired.",
  business_suspended: "Your business is suspended. Please contact Pointidi support.",
