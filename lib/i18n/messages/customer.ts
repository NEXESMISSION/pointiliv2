...
export const customer = ns({
  ...
  tn: {
    ...
    cards: {
      ...
      emptyBody: "الكارط متاعك تبان هنا بعد أول تامبون في محل Pointili.",
    },

    card: {
      title: "كارط الوفاء",
      addedTitle: "تزادت الكارط",
      addedBody: "كي تخلّص، سكاني الكود اللي في شاشة الكونتوار باش تاخو أول تامبون.",
    ...
    use: {
      ...
      expired: "الكود هذا فات وقتو. التامبونات متاعك في أمان — اطلب كود جديد.",
    ...
    install: {
      ...
      action: "نزّل",
      notNow: "موش توّا",
      rowTitle: "زيد Pointili لشاشة التليفون",
