...
export const scan = ns({
  fr: {
    ...
    signIn: {
      title: "Prenez votre tampon",
      body: "Votre numéro et un mot de passe. C'est tout.",
      firstTime: "Première fois ? Le compte se crée tout seul.",
      submit: "Prendre mon tampon",
  ...
  tn: {
    ...
    needsAccount: {
      ...
      body: "اعمل حساب Pointili باش تاخو التامبون متاعك",
      at: "في",
      held: "التامبون متاعك محفوظ 20 دقيقة",
    ...
    join: {
      ...
      noRewardLine: "لمّ التامبونات في كل زيارة وخوذ كوادو.",
      paused: "المحل هذا وقّف التامبونات توّا. أما تنجم زيد الكارط.",
    ...
    signIn: {
      title: "خوذ التامبون متاعك",
      body: "نومروك وكلمة سر. وخلاص.",
      firstTime: "أوّل مرّة؟ الكونت يتعمل وحدو.",
      submit: "خوذ التامبون",
      submitting: "ثانية برك…",
      wrongPassword: "كلمة السر موش صحيحة.",
