...
export const common = ns({
  ...
  tn: {
    site: {
      ...
      description: "خلّي حرفاءك يرجعولك ديما. يسكانيو الكود متاعك في الكونتوار، يلمّو الطوابع في التليفون وياخذو كوادو. للقهاوي والمطاعم وصالونات الحلاقة والحوانت في تونس.",
    },
    save: "سجّل",
    saving: "قاعد يسجّل…",
    saved: "تسجّل",
    ...
    stamps: "طوابع",
    customers: "حرفاء",
    stampsCount: p({ one: "طابع واحد", other: "{n} طوابع" }),
    customersCount: p({ one: "حريف واحد", other: "{n} حرفاء" }),
    visitsCount: p({ one: "زيارة واحدة", other: "{n} زيارات" }),
    stampsToGo: p({ one: "مازال طابع واحد", other: "مازال {n} طوابع" }),
    outOf: "{done}/{total}",
    errorTitle: "صار مشكل",
    errorBody: "ما نجّمناش نحمّلو الصفحة. الطوابع والكوادو متاعك في أمان — عاود جرّب.",
