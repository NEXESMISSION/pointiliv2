  ...
  return (
    <>
      ...
      {joined && customer.total_stamps === 0 && (
        <Alert tone="success" title={t.customer.card.addedTitle} className="mt-4 animate-rise">
        ...
        <section className="mt-5 space-y-3">
          {unlocked.map((r) => (
            <div key={r.id} className="animate-rise rounded-3xl bg-white p-5 text-center shadow-card">
              ...
              <p className="mt-1 text-sm font-semibold text-success-600">{t.customer.card.unlockedTitle}</p>
              ...
              <p className="mx-auto mt-2 max-w-xs text-xs text-muted">{t.customer.card.showAtCounter}</p>
              <div className="mt-4">
